...
$query2 = $connect->prepare("UPDATE T_Record_Master SET RecordCreatedDateTime = '$RecordCreatedDateTime' ,InspectionCount = '$InspectionCount', InspectionUserID = '$InspectionUserID', VerifiedDate = '$date_verify', VerifierID = '$verify_by', RecordStatusFlag = '$RecordStatusFlag' WHERE RecordID = '$RecordID'");
$query2->execute();
...
$query1 = $connect->prepare("UPDATE T_Lot_SFG SET PlantKey = '$PlantKey', BatchNumber = '$BatchNumber', Customer = '$Customer', Brand = '$Brand', LotNumber = '$LotNumber', InspectionPlanKey = '$InspectionPlanKey', CartonQuantity = '$CartonQuantity' WHERE LotIDKey = '$LotIDKey'");
$query1->execute();
...
//--------------------------------------------------OTHER TESTING & PHYSICAL DIMENSION TEST--------------------------------------------//
        ...
        SET DefectValue = (case
                            ...
                            when DefectKey = 146 then '$MG'
                            when DefectKey = 147 then '$MS'
                            when DefectKey = 148 then '$GF'
