<?php
        if (isset($_POST['submit']))
        {
            ...
            $ctnPerPallet2          = $_POST['Sampling-ctn-pallet_2'];
...
$connect->beginTransaction();
{
  ...
  $stmt->bindParam(20, $null ); //country
  $stmt->bindParam(21, $null ); //material_code
  $stmt->bindParam(22, $oldBatchNumber ); //so_line_item
  $stmt->bindParam(23, $ctnPerPallet );
  $stmt->bindParam(24, $ctnPerPallet2);
  $stmt->bindParam(25, $innerPerCtn1);
  $stmt->bindParam(26, $innerPerCtn2);
  $stmt->bindParam(27, $pcsPerInner1);
  $stmt->bindParam(28, $pcsPerInner2);
  $stmt->bindParam(29, $InspectionCount, PDO::PARAM_INT);
  $stmt->bindParam(30, $RecordCreatedDateTime);
  $stmt->bindParam(31, $InspectionUserID, PDO::PARAM_INT);
  $stmt->bindParam(32, $RecordStatusFlag, PDO::PARAM_INT);
  $stmt->bindParam(33, $VerifierID);
  $stmt->bindParam(34, $VerifiedDate);
  $stmt->bindParam(35, $RecordIDPreset);
  $stmt->bindParam(36, $InstrumentResult_JSON);
  $stmt->bindParam(37, $TestResult_JSON);
  $stmt->bindParam(38, $DefectResult_JSON);
  $stmt->bindParam(39, $AQLResult_JSON);
  $stmt->bindParam(40, $SampleSizeResult_JSON);
  $stmt->bindParam(41, $UDResultKey);
