...
$sql .= "SELECT * FROM M_InspectionPlan WITH (NOLOCK) WHERE InspectionPlanKey IN (1,2,4,11);";
              ...
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control fstdropdown-select" id="PlantName" name="PlantName" required></td>
                      ...
                      <?php foreach ($Dimplant as $row) { ?>
                        <option name="PlantName" value="<?php echo $row['PlantName']; ?>"><?php echo $row['PlantName'];
                                                                                        } ?></option>
                    </select>
                  </div>
                  <!-- /.form-group -->
                  ...
                  <div class="form-group">
                    ...
                    <select name="SurfaceCode" id="SurfaceCode" class=" form-control gloveSurface">
                  ...
                  <div class="form-group">
                    ...
                    <label>Size:</label>
                    <select name="GloveSizeCodeLong" id="GloveSizeCodeLong" class=" form-control gloveSizePrimary">
                ...
                <div class="col-lg-6">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" id="CustomerName" name="CustomerName" required>
                      ...
                      <?php foreach ($M_Customer as $row) { ?>
                        <option name="CustomerName" value="<?php echo $row['CustomerName']; ?>"><?php echo $row['CustomerName'];
                                                                                              } ?></option>
                    </select>
                  </div>
                  <!-- /.form-group -->
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" id="BrandName" name="BrandName" required>
                      ...
                      <?php foreach ($M_Brand as $row) { ?>
                        <option name="BrandName" value="<?php echo $row['BrandName']; ?>"><?php echo $row['BrandName'];
                                                                                        } ?></option>
                    </select>
                  </div>
                  <!-- /.form-group -->
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="SOLineItemNumber" id="SOLineItemNumber" placeholder="Enter SO Line Item Number" required>
                  </div>
                  <!-- /.form-group -->
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" id="GloveProductTypeName" name="GloveProductTypeName" required>
                      <option class="form-control" name="GloveProductTypeName" value="">Product</option>
                      <?php foreach ($M_GloveProductType as $row) { ?>
                        <option name="GloveProductTypeName" value="<?php echo $row['GloveProductTypeName']; ?>"><?php echo $row['GloveProductTypeName'];
                                                                                                              } ?></option>
                    </select>
                  </div>
                  <!-- /.form-group -->
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" id="GloveCodeLong" name="GloveCodeLong" required>
                      <option class="form-control" name="GloveCodeLong" value="">Product Code</option>
                      <?php foreach ($M_GloveCode as $row) { ?>
                        <option name="GloveCodeLong" value="<?php echo $row['GloveCodeLong']; ?>"><?php echo $row['GloveCodeLong'];
                                                                                                } ?></option>
                    </select>
                  </div>
                  <!-- /.form-group -->
                  ...
                  <div class="form-group">
                    <label>Colour:</label>
                    <input type="hidden" class="form-control" name="GloveColourName" id="GloveColourName" readonly>
                    
                    <select class="form-control" id="GloveColourCode" name="GloveColourCode" required>
                      <option class="form-control" name="GloveColourCode" value=""> Colour</option>
                      <?php foreach ($M_GloveColour as $row) { ?>
                        <option name="GloveColourCode" value="<?php echo $row['GloveColourCode']; ?>"><?php echo $row['GloveColourName'];
                                                                                                    } ?></option>
                    </select>
                  </div>
                  <!-- /.form-group -->
