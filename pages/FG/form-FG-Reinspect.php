                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="hidden" class="form-control" name="SurfaceCode" id="SurfaceCode" value="<?php echo $T_Lot_FG['GloveSurfaceCode']; ?>" readonly>
                        ...
                        <td>
                          ...
                          <script>
                            $('.TestValue13').ready(function() {
                              ...
                              console.log('TestValue13 : ' + TestValue13);
