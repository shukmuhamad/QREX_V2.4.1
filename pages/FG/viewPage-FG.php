  ...
  <body>
    ...
    $recordInstrument_pivot = array();
    for ($i = 0; $i < count($T_Record_Instrument); $i++) {
      $recordInstrument_pivot_temp = array(
        $T_Record_Instrument[$i]['InstrumentName'] => $T_Record_Instrument[$i]['InstrumentValue']
      );
      $recordInstrument_pivot = array_merge($recordInstrument_pivot, $recordInstrument_pivot_temp);
    }

    $recordSampleSize_pivot = array();
    for ($i = 0; $i < count($T_Record_SampleSize); $i++) {
      $recordSampleSize_pivot_temp = array(
        $T_Record_SampleSize[$i]['TestName'] => $T_Record_SampleSize[$i]['SampleSizeValue']
      );
      $recordSampleSize_pivot = array_merge($recordSampleSize_pivot, $recordSampleSize_pivot_temp);
    }
        ...
        <div class="panel-body">
          <div class="row">
            ...
            <div class="col-lg-6">
              ...
              <div class="form-group">
                Material code: <label><?php echo $T_Lot_FG['material_code']; ?></label>
              </div>
              <!-- /.form-group -->

              <div class="form-group">
                Suface: <label><?php
                                echo $T_Lot_FG['GloveSurfaceName']; ?></label>
              </div>
              <!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <label>
                  <?php
                  $oldRef_arr = explode("-", $T_Lot_FG['OldBatchNumber']);
                  ...
                  if ($T_Record_Master['RecordStatusFlag'] == '9') echo "Free Stock";
                  ?>
                </label></br>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              ...
              <div class="form-group">
                Country:
                <label><?php echo $T_Lot_FG['Country']; ?></label>
              </div>
              ...
              <div class="form-group">
                SO Line Item Number:
                <label><?php echo $T_Lot_FG['so_line_item']; ?></label>
              </div>
              <!-- /.form-group -->
            ...
            <div class="col-lg-12">
              ...
              <div class="form-group col-lg-2">
                1. Sampling ctn /pallet: <label><?php echo $T_Lot_FG['CartonPerPallet']; ?></label>
              </div>
              <!-- /.form-group -->

              <div class="form-group col-lg-2">
                1. Sampling Inner /ctn: <label><?php echo $T_Lot_FG['InnerPerCarton_1']; ?></label>
              </div>
              <!-- /.form-group -->

              <div class="form-group col-lg-2">
                1. Sampling pcs /Inner: <label><?php echo $T_Lot_FG['PcsPerInner_1']; ?></label>
              </div>
              <!-- /.form-group -->

              <div class="form-group col-lg-2">
                2. Sampling ctn /pallet: <label><?php echo $T_Lot_FG['CartonPerPallet_2']; ?></label>
              </div>
              <!-- /.form-group -->
              <div class="form-group col-lg-2">
                2. Sampling Inner /ctn: <label><?php echo $T_Lot_FG['InnerPerCarton_2']; ?></label>
              </div>
              <!-- /.form-group -->

              <div class="form-group col-lg-2">
                2. Sampling pcs /Inner: <label><?php echo $T_Lot_FG['PcsPerInner_2']; ?></label>
              </div>
              <!-- /.form-group -->
            </div>
            <!-- /.col-lg-12 -->
          ...
          <div class="col-lg-12">
            <div class="panel panel-primary">
              ...
              <div class="col-lg-6"></br>
                ...
                <div class="form-group">
                  Weighing Scale ID: <label><?php echo $recordInstrument_pivot['Weighing Scale ID']; ?></label>
                </div>

                <div class="form-group">
                  Ruler ID:<label> <?php echo $recordInstrument_pivot['Ruler ID']; ?> </label>
                </div>

                <div class="form-group">
                  Thickness Gauge ID:<label> <?php echo $recordInstrument_pivot['Thickness Gauge']; ?></label>
                </div>
                <br>
                <!-----------------------------------------------------------2. TEST RESULT--------------------------------------------------------------------------->
                ...
                <div class="form-group">
                  ...
                  <?php } else { ?>
                    <label><?php echo  $testResult_pivot['CountingTest'];
                          } ?></label>
                </div>

                <?php if (isset($testResult_pivot['PackagingDefectsTest'])) { ?>
                  <div class="form-group">
                    Packaging Defect:
                    ...
                    <?php } else { ?>
                      <label><?php echo $testResult_pivot['PackagingDefectsTest'];
                            } ?></label>
                  </div>
                <?php } ?>
              </div><br>

              <!-----------------------------------------------------------3. INTERNAL PHYSICAL TESTING ------------------------------------------------------------>
              <!-- /.col-lg-6 (nested) -->
              <div class="col-lg-4">
            ...
            <div class="col-lg-12">
              <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
                ...
                <tr>
                  ...
                  <td><?php echo $recordSampleSize_pivot['SampleSizeAPT/WTTLevel1']; ?></td>

                  <th scope="col" class="info">SAMPLE SIZE VT:</th>
                  <td><?php echo $recordSampleSize_pivot['SampleSizeVisual']; ?></td>
                </tr>

                <tr>
                  <th scope="col" class="info">SAMPLE SIZE APT/WTT (LEVEL 2):</th>
                  <td><?php echo $recordSampleSize_pivot['SampleSizeAPT/WTTLevel2']; ?></td>

                  <th scope="col" class="info">MACHINE ID:</th>
                  <td><?php echo $recordInstrument_pivot['APT/WTT ID']; ?></td>
              ...
              <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
                ...
                <tr>
                  ...
                  <td>DB:
                    <b>
                      <font color="red"><?php callDefectValue(1, $defectResult_pivot); ?></font>
                  </td>
                  <td>SD:
                    <b>
                      <font color="red"><?php callDefectValue(2, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>CA:
                    <b>
                      <font color="red"><?php callDefectValue(4, $defectResult_pivot); ?></font>
                  </td>
                  <td>CL:
                    <b>
                      <font color="red"><?php callDefectValue(5, $defectResult_pivot); ?></font>
                  </td>
                  <td>CLD:
                    <b>
                      <font color="red"><?php callDefectValue(6, $defectResult_pivot); ?></font>
                  </td>
                  <td>CS:
                    <b>
                      <font color="red"><?php callDefectValue(7, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>BPC:
                    <b>
                      <font color="red"><?php callDefectValue(51, $defectResult_pivot); ?></font>
                  </td>
                  <td>CR:
                    <b>
                      <font color="red"><?php callDefectValue(52, $defectResult_pivot); ?></font>
                  </td>
                  <td>DC:
                    <b>
                      <font color="red"><?php callDefectValue(53, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>CH:
                    <b>
                      <font color="red"><?php callDefectValue(68, $defectResult_pivot); ?></font>
                  </td>
                  <td>FK:
                    <b>
                      <font color="red"><?php callDefectValue(69, $defectResult_pivot); ?></font>
                  </td>
                  <td>MF:
                    <b>
                      <font color="red"><?php callDefectValue(70, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>BF:
                    <b>
                      <font color="red"><?php callDefectValue(77, $defectResult_pivot); ?></font>
                  </td>
                  <td>CF:
                    <b>
                      <font color="red"><?php callDefectValue(78, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>BF:
                    <b>
                      <font color="red"><?php callDefectValue(88, $defectResult_pivot); ?></font>
                  </td>
                  <td>CF:
                    <b>
                      <font color="red"><?php callDefectValue(89, $defectResult_pivot); ?></font>
                  </td>

                  <!------------ DEF GG L1 ----------------------------------->
                  <td>GG:
                    <b>
                      <font color="red"><?php callDefectValue(168, $defectResult_pivot); ?></font>
                  </td>
                  <td></td>
                ...
                <tr>
                  ...
                  <td>SP:
                    <b>
                      <font color="red"><?php callDefectValue(3, $defectResult_pivot); ?></font>
                  </td>
                  <td>STNs:
                    <b>
                      <font color="red"><?php callDefectValue(158, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>DF:
                    <b>
                      <font color="red"><?php callDefectValue(8, $defectResult_pivot); ?></font>
                  </td>
                  <td>DT:
                    <b>
                      <font color="red"><?php callDefectValue(9, $defectResult_pivot); ?></font>
                  </td>
                  <td>EFI:
                    <b>
                      <font color="red"><?php callDefectValue(10, $defectResult_pivot); ?></font>
                  </td>
                  <td>FM:
                    <b>
                      <font color="red"><?php callDefectValue(11, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>DD:
                    <b>
                      <font color="red"><?php callDefectValue(54, $defectResult_pivot); ?></font>
                  </td>
                  <td>DIS:
                    <b>
                      <font color="red"><?php callDefectValue(55, $defectResult_pivot); ?></font>
                  </td>
                  <td>FMT:
                    <b>
                      <font color="red"><?php callDefectValue(56, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>TAH:
                    <b>
                      <font color="red"><?php callDefectValue(71, $defectResult_pivot); ?></font>
                  </td>
                  <td>TH:
                    <b>
                      <font color="red"><?php callDefectValue(72, $defectResult_pivot); ?></font>
                  </td>
                  <td>TR:
                    <b>
                      <font color="red"><?php callDefectValue(73, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>CHs:
                    <b>
                      <font color="red"><?php callDefectValue(79, $defectResult_pivot); ?></font>
                  </td>
                  <td>FKs:
                    <b>
                      <font color="red"><?php callDefectValue(80, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>CHs:
                    <b>
                      <font color="red"><?php callDefectValue(90, $defectResult_pivot); ?></font>
                  </td>
                  <td>FKs:
                    <b>
                      <font color="red"><?php callDefectValue(91, $defectResult_pivot); ?></font>
                  </td>
                ...
                <tr>
                  ...
                  <td>SLDs:
                    <b>
                      <font color="red"><?php callDefectValue(160, $defectResult_pivot); ?></font>
                  </td>
                  <td>Ls:
                    <b>
                      <font color="red"><?php callDefectValue(161, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>FNO:
                    <b>
                      <font color="red"><?php callDefectValue(12, $defectResult_pivot); ?></font>
                  </td>
                  <td>FO:
                    <b>
                      <font color="red"><?php callDefectValue(13, $defectResult_pivot); ?></font>
                  </td>
                  <td>GNO:
                    <b>
                      <font color="red"><?php callDefectValue(14, $defectResult_pivot); ?></font>
                  </td>
                  <td>IB:
                    <b>
                      <font color="red"><?php callDefectValue(15, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>GL:
                    <b>
                      <font color="red"><?php callDefectValue(57, $defectResult_pivot); ?></font>
                  </td>
                  <td>L:
                    <b>
                      <font color="red"><?php callDefectValue(58, $defectResult_pivot); ?></font>
                  </td>
                  <td>MP:
                    <b>
                      <font color="red"><?php callDefectValue(59, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>GSH:
                    <b>
                      <font color="red"><?php callDefectValue(148, $defectResult_pivot); ?></font>
                  </td>
                  <td></td>
                  <td></td>
                  ...
                  <td>FT:
                    <b>
                      <font color="red"><?php callDefectValue(81, $defectResult_pivot); ?></font>
                  </td>
                  <td>GB:
                    <b>
                      <font color="red"><?php callDefectValue(82, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>FT:
                    <b>
                      <font color="red"><?php callDefectValue(92, $defectResult_pivot); ?></font>
                  </td>
                  <td>GB:
                    <b>
                      <font color="red"><?php callDefectValue(93, $defectResult_pivot); ?></font>
                  </td>
                ...
                <tr>
                  ...
                  <td>TSs:
                    <b>
                      <font color="red"><?php callDefectValue(169, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>ICT:
                    <b>
                      <font color="red"><?php callDefectValue(16, $defectResult_pivot); ?></font>
                  </td>
                  <td>L:
                    <b>
                      <font color="red"><?php callDefectValue(17, $defectResult_pivot); ?></font>
                  </td>
                  <td>LS:
                    <b>
                      <font color="red"><?php callDefectValue(18, $defectResult_pivot); ?></font>
                  </td>
                  <td>PLM:
                    <b>
                      <font color="red"><?php callDefectValue(19, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>NB:
                    <b>
                      <font color="red"><?php callDefectValue(60, $defectResult_pivot); ?></font>
                  </td>
                  <td>NF:
                    <b>
                      <font color="red"><?php callDefectValue(61, $defectResult_pivot); ?></font>
                  </td>
                  <td>PGM:
                    <b>
                      <font color="red"><?php callDefectValue(62, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>P:
                    <b>
                      <font color="red"><?php callDefectValue(83, $defectResult_pivot); ?></font>
                  </td>
                  <td>SF:
                    <b>
                      <font color="red"><?php callDefectValue(84, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>P:
                    <b>
                      <font color="red"><?php callDefectValue(94, $defectResult_pivot); ?></font>
                  </td>
                  <td>SF:
                    <b>
                      <font color="red"><?php callDefectValue(95, $defectResult_pivot); ?></font>
                  </td>
                ...
                <tr>
                  ...
                  <td>PMI:
                    <b>
                      <font color="red"><?php callDefectValue(20, $defectResult_pivot); ?></font>
                  </td>
                  <td>PMO:
                    <b>
                      <font color="red"><?php callDefectValue(21, $defectResult_pivot); ?></font>
                  </td>
                  <td>RC:
                    <b>
                      <font color="red"><?php callDefectValue(22, $defectResult_pivot); ?></font>
                  </td>
                  <td>RM:
                    <b>
                      <font color="red"><?php callDefectValue(23, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>SDG:
                    <b>
                      <font color="red"><?php callDefectValue(63, $defectResult_pivot); ?></font>
                  </td>
                  <td>TW:
                    <b>
                      <font color="red"><?php callDefectValue(64, $defectResult_pivot); ?></font>
                  </td>
                  <td>URD:
                    <b>
                      <font color="red"><?php callDefectValue(65, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>TAHs:
                    <b>
                      <font color="red"><?php callDefectValue(85, $defectResult_pivot); ?></font>
                  </td>
                  <td>THs:
                    <b>
                      <font color="red"><?php callDefectValue(86, $defectResult_pivot); ?></font>
                  </td>

                  <!------------ DEF HOLES 2 L5 ---------------------------------------->
                  <td>TAHs:
                    <b>
                      <font color="red"><?php callDefectValue(96, $defectResult_pivot); ?></font>
                  </td>
                  <td>THs:
                    <b>
                      <font color="red"><?php callDefectValue(97, $defectResult_pivot); ?></font>
                  </td>
                ...
                <tr>
                  ...
                  <td>SAG:
                    <b>
                      <font color="red"><?php callDefectValue(24, $defectResult_pivot); ?></font>
                  </td>
                  <td>SG:
                    <b>
                      <font color="red"><?php callDefectValue(25, $defectResult_pivot); ?></font>
                  </td>
                  <td>SHN:
                    <b>
                      <font color="red"><?php callDefectValue(26, $defectResult_pivot); ?></font>
                  </td>
                  <td>SI:
                    <b>
                      <font color="red"><?php callDefectValue(27, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>WE:
                    <b>
                      <font color="red"><?php callDefectValue(66, $defectResult_pivot); ?></font>
                  </td>
                  <td>WG:
                    <b>
                      <font color="red"><?php callDefectValue(67, $defectResult_pivot); ?></font>
                  </td>
                  <td>MS:
                    <b>
                      <font color="red"><?php callDefectValue(147, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>TRs:
                    <b>
                      <font color="red"><?php callDefectValue(87, $defectResult_pivot); ?></font>
                  </td>
                  <td>L:
                    <b>
                      <font color="red"><?php callDefectValue(143, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>TRs:
                    <b>
                      <font color="red"><?php callDefectValue(98, $defectResult_pivot); ?></font>
                  </td>
                  <td>L:
                    <b>
                      <font color="red"><?php callDefectValue(144, $defectResult_pivot); ?></font>
                  </td>
                ...
                <tr>
                  ...
                  <td>SKV:
                    <b>
                      <font color="red"><?php callDefectValue(28, $defectResult_pivot); ?></font>
                  </td>
                  <td>SLD:
                    <b>
                      <font color="red"><?php callDefectValue(29, $defectResult_pivot); ?></font>
                  </td>
                  <td>SO:
                    <b>
                      <font color="red"><?php callDefectValue(30, $defectResult_pivot); ?></font>
                  </td>
                  <td>STK:
                    <b>
                      <font color="red"><?php callDefectValue(31, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>PFK:
                    <b>
                      <font color="red"><?php callDefectValue(149, $defectResult_pivot); ?></font>
                  </td>
                  <td>MG:
                    <b>
                      <font color="red"><?php callDefectValue(162, $defectResult_pivot); ?></font>
                  </td>
                  <td>MD:
                    <b>
                      <font color="red"><?php callDefectValue(163, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>LH:
                    <b>
                      <font color="red"><?php callDefectValue(150, $defectResult_pivot); ?></font>
                  </td>
                  <td>MH:
                    <b>
                      <font color="red"><?php callDefectValue(155, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>LH:
                    <b>
                      <font color="red"><?php callDefectValue(151, $defectResult_pivot); ?></font>
                  </td>
                  <td>MH:
                    <b>
                      <font color="red"><?php callDefectValue(156, $defectResult_pivot); ?></font>
                  </td>
                ...
                <tr>
                  ...
                  <td>STN:
                    <b>
                      <font color="red"><?php callDefectValue(32, $defectResult_pivot); ?></font>
                  </td>
                  <td>TA:
                    <b>
                      <font color="red"><?php callDefectValue(33, $defectResult_pivot); ?></font>
                  </td>
                  <td>TS:
                    <b>
                      <font color="red"><?php callDefectValue(34, $defectResult_pivot); ?></font>
                  </td>
                  <td>UNF:
                    <b>
                      <font color="red"><?php callDefectValue(35, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>TP:
                    <b>
                      <font color="red"><?php callDefectValue(164, $defectResult_pivot); ?></font>
                  </td>
                  <td>SVD:
                    <b>
                      <font color="red"><?php callDefectValue(165, $defectResult_pivot); ?></font>
                  </td>
                  <td></td>
                ...
                <tr>
                  ...
                  <td>WL:
                    <b>
                      <font color="red"><?php callDefectValue(36, $defectResult_pivot); ?></font>
                  </td>
                  <td>WSI:
                    <b>
                      <font color="red"><?php callDefectValue(37, $defectResult_pivot); ?></font>
                  </td>
                  <td>WSO:
                    <b>
                      <font color="red"><?php callDefectValue(38, $defectResult_pivot); ?></font>
                  </td>
                  <td>GF:
                    <b>
                      <font color="red"><?php callDefectValue(146, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>ICP:
                    <b>
                      <font color="red"><?php callDefectValue(74, $defectResult_pivot); ?></font>
                  </td>
                  <td>NP:
                    <b>
                      <font color="red"><?php callDefectValue(75, $defectResult_pivot); ?></font>
                  </td>
                  <td>WP:
                    <b>
                      <font color="red"><?php callDefectValue(76, $defectResult_pivot); ?></font>
                  </td>
                ...
                <tr>
                  ...
                  <td>BP:
                    <b>
                      <font color="red"><?php callDefectValue(40, $defectResult_pivot); ?></font>
                  </td>
                  <td>DP:
                    <b>
                      <font color="red"><?php callDefectValue(41, $defectResult_pivot); ?></font>
                  </td>
                  <td>DSP:
                    <b>
                      <font color="red"><?php callDefectValue(42, $defectResult_pivot); ?></font>
                  </td>
                  <td>DTP:
                    <b>
                      <font color="red"><?php callDefectValue(43, $defectResult_pivot); ?></font>
                  </td>
                ...
                <tr>
                  ...
                  <td>IA:
                    <b>
                      <font color="red"><?php callDefectValue(44, $defectResult_pivot); ?></font>
                  </td>
                  <td>IFS:
                    <b>
                      <font color="red"><?php callDefectValue(45, $defectResult_pivot); ?></font>
                  </td>
                  <td>IP:
                    <b>
                      <font color="red"><?php callDefectValue(46, $defectResult_pivot); ?></font>
                  </td>
                  <td>OP:
                    <b>
                      <font color="red"><?php callDefectValue(47, $defectResult_pivot); ?></font>
                  </td>
                ...
                <tr>
                  ...
                  <td>RP:
                    <b>
                      <font color="red"><?php callDefectValue(48, $defectResult_pivot); ?></font>
                  </td>
                  <td>SH:
                    <b>
                      <font color="red"><?php callDefectValue(49, $defectResult_pivot); ?></font>
                  </td>
                  <td>SMP:
                    <b>
                      <font color="red"><?php callDefectValue(50, $defectResult_pivot); ?></font>
                  </td>
                  <td></td>
                ...
                <tr>
                  ...
                  <td>FKI:
                    <b>
                      <font color="red"><?php callDefectValue(166, $defectResult_pivot); ?></font>
                  </td>
                  <td>FKO:
                    <b>
                      <font color="red"><?php callDefectValue(167, $defectResult_pivot); ?></font>
                  </td>
                  <td></td>
                  <td></td>
              ...
              <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
                ...
                <tr>
                  ...
                  <td colspan="3"><?php echo $AQLResult_pivot['AQLRegulatoryPackaging']; ?></td>
                  <td colspan="4"><?php echo $AQLResult_pivot['AQLCriticalPackaging']; ?></td>
                  <td colspan="4"><?php echo $AQLResult_pivot['AQLVisualPackaging']; ?></td>

                </tr>

                <tr>
                  <th scope="col" class="info">Acceptance:</th>
                  <td colspan="3"><?php echo $AQLResult_pivot['AcceptanceRegulatoryPackaging']; ?></td>
                  <td colspan="4"><?php echo $AQLResult_pivot['AcceptanceCriticalPackaging']; ?></td>
                  <td colspan="4"><?php echo $AQLResult_pivot['AcceptanceVisualPackaging']; ?></td>
                ...
                <tr>
                  ...
                  <td>WLN:
                    <b>
                      <font color="red"><?php callDefectValue(113, $defectResult_pivot); ?></font>
                  </td>
                  <td>WMD:
                    <b>
                      <font color="red"><?php callDefectValue(114, $defectResult_pivot); ?></font>
                  </td>
                  <td>WED:
                    <b>
                      <font color="red"><?php callDefectValue(112, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>WQ:
                    <b>
                      <font color="red"><?php callDefectValue(133, $defectResult_pivot); ?></font>
                  </td>
                  <td>MS:
                    <b>
                      <font color="red"><?php callDefectValue(122, $defectResult_pivot); ?></font>
                  </td>
                  <td>MB:
                    <b>
                      <font color="red"><?php callDefectValue(119, $defectResult_pivot); ?></font>
                  </td>
                  <td>MLN:
                    <b>
                      <font color="red"><?php callDefectValue(120, $defectResult_pivot); ?></font>
                  </td>
                  ...
                  <td>WT:
                    <b>
                      <font color="red"><?php callDefectValue(142, $defectResult_pivot); ?></font>
                  </td>
                  <td>CT:
                    <b>
                      <font color="red"><?php callDefectValue(135, $defectResult_pivot); ?></font>
                  </td>
                  <td>POP:
                    <b>
                      <font color="red"><?php callDefectValue(140, $defectResult_pivot); ?></font>
                  </td>
                  <td></td>
                </tr>
                ...
                <tr>
                  ...
                  <td>WPC:
                    <b>
                      <font color="red"><?php callDefectValue(115, $defectResult_pivot); ?></font>
                  </td>
                  <td>MM:
                    <b>
                      <font color="red"><?php callDefectValue(111, $defectResult_pivot); ?></font>
                  </td>
                  <td>IP:
                    <b>
                      <font color="red"><?php callDefectValue(110, $defectResult_pivot); ?></font>
                  </td>

                  <!----------------------------CRITICAL PACKAGING L2------------------>
                  <td>WGS:
                    <b>
                      <font color="red"><?php callDefectValue(129, $defectResult_pivot); ?></font>
                  </td>
                  <td>WGT:
                    <b>
                      <font color="red"><?php callDefectValue(130, $defectResult_pivot); ?></font>
                  </td>
                  <td>WGA:
                    <b>
                      <font color="red"><?php callDefectValue(128, $defectResult_pivot); ?></font>
                  </td>
                  <td>OS:
                    <b>
                      <font color="red"><?php callDefectValue(124, $defectResult_pivot); ?></font>
                  </td>
                  <!------------ VISUAL PACKAGING L2 ------------------------------------->
                  <td>FG:
                    <b>
                      <font color="red"><?php callDefectValue(137, $defectResult_pivot); ?></font>
                  </td>
                  <td>PIS:
                    <b>
                      <font color="red"><?php callDefectValue(139, $defectResult_pivot); ?></font>
                  </td>
                  <td>MSA:
                    <b>
                      <font color="red"><?php callDefectValue(138, $defectResult_pivot); ?></font>
                  </td>
                  <td></td>
                </tr>
                ...
                <tr>
                  ...
                  <td>WTS:
                    <b>
                      <font color="red"><?php callDefectValue(134, $defectResult_pivot); ?></font>
                  </td>
                  <td>PTS:
                    <b>
                      <font color="red"><?php callDefectValue(126, $defectResult_pivot); ?></font>
                  </td>
                  <td>WPO:
                    <b>
                      <font color="red"><?php callDefectValue(132, $defectResult_pivot); ?></font>
                  </td>
                  <td>DMG:
                    <b>
                      <font color="red"><?php callDefectValue(117, $defectResult_pivot); ?></font>
                  </td>
                  <!------------ VISUAL PACKAGING L3 ------------------------------------->

                  <td>WIS:
                    <b>
                      <font color="red"><?php callDefectValue(141, $defectResult_pivot); ?></font>
                  </td>
                  <td>DT:
                    <b>
                      <font color="red"><?php callDefectValue(136, $defectResult_pivot); ?></font>
                  </td>
                  <td></td>
                  <td></td>
                </tr>
                ...
                <tr>
                  ...
                  <td>MSG:
                    <b>
                      <font color="red"><?php callDefectValue(121, $defectResult_pivot); ?></font>
                  </td>
                  <td>FC:
                    <b>
                      <font color="red"><?php callDefectValue(118, $defectResult_pivot); ?></font>
                  </td>
                  <td>POS:
                    <b>
                      <font color="red"><?php callDefectValue(125, $defectResult_pivot); ?></font>
                  </td>
                  <td>BC:
                    <b>
                      <font color="red"><?php callDefectValue(116, $defectResult_pivot); ?></font>
                  </td>
                  <!------------ VISUAL PACKAGING L4 ------------------------------------->
                  <td></td>
                  <td></td>
                ...
                <tr>
                  ...
                  <td>WPD:
                    <b>
                      <font color="red"><?php callDefectValue(131, $defectResult_pivot); ?></font>
                  </td>
                  <td>MSI:
                    <b>
                      <font color="red"><?php callDefectValue(123, $defectResult_pivot); ?></font>
                  </td>
                  <td>TRP:
                    <b>
                      <font color="red"><?php callDefectValue(127, $defectResult_pivot); ?></font>
                  </td>
                  <td>NCN:
                    <b>
                      <font color="red"><?php callDefectValue(170, $defectResult_pivot); ?></font>
                  </td>
                ...
                <tr>
                  ...
                  <td>CNS:
                    <b>
                      <font color="red"><?php callDefectValue(171, $defectResult_pivot); ?></font>
                  </td>
                  <td></td>
                  <td></td>
                  <td></td>
              ...
              <div class="form-group">
                ...
                Date:<label><?php
                            if (!isset($T_Record_Master['VerifierID']) && $T_Record_Master['VerifierID'] == '') {
                            } else {
                              echo $date2;
                            } ?></label>
              </div>
              ...
              <center>
                ...
                ?>
                  <a class="btn btn-success" target="_blank" href="form-FG-Edit.php?LotIDKey=<?php echo $lotID; ?>&RecordID=<?php echo $RecordID; ?>"> Update/Verify</a>&nbsp;&nbsp;&nbsp;&nbsp;
                <?php
                }
                ?>
                <?php
                ...
                ?>
                  <a class="btn btn-warning" target="_blank" href="form-FG-Reinspect.php?LotIDKey=<?php echo $lotID; ?>&RecordID=<?php echo $RecordID; ?>"> Reinspec</a>&nbsp;&nbsp;
                <?php
                }
                ?>
