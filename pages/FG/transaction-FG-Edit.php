...
foreach($result as $row)
{
  ...
  $colVal_array = array(
    ...
    // ),array(
    //   "col"=>"materialCode",
    //   "newcolval"=>$materialCode,
    //   "oldcolval"=>$T_Lot_FG['materialCode'],
    ),array(
      "col"=>"Country",
      "newcolval"=>$Country,
      "oldcolval"=>$T_Lot_FG['Country'],
    ),array(
      "col"=>"so_line_item",
      "newcolval"=>$SOLineItemNumber,
      "oldcolval"=>$T_Lot_FG['so_line_item'],
    ),array(
      "col"=>"OldBatchNumber",
      "newcolval"=>$oldBatchNumber,
      "oldcolval"=>$T_Lot_FG['OldBatchNumber'],
    ),array(
      "col"=>"CartonPerPallet",
      "newcolval"=>$ctnPerPallet,
      "oldcolval"=>$T_Lot_FG['CartonPerPallet'],
    ), array(
      "col" => "CartonPerPallet_2",
      "newcolval" => $ctnPerPallet2,
      "oldcolval" => $T_Lot_FG['CartonPerPallet_2'],
    ),array(
      "col"=>"InnerPerCarton_1",
      "newcolval"=>$innerPerCtn1,
      "oldcolval"=>$T_Lot_FG['InnerPerCarton_1'],
    ),array(
      "col"=>"InnerPerCarton_2",
      "newcolval"=>$innerPerCtn2,
      "oldcolval"=>$T_Lot_FG['InnerPerCarton_2'],
    ),array(
      "col"=>"PcsPerInner_1",
      "newcolval"=>$pcsPerInner1,
      "oldcolval"=>$T_Lot_FG['PcsPerInner_1'],
    ),array(
      "col"=>"PcsPerInner_2",
      "newcolval"=>$pcsPerInner2,
      "oldcolval"=>$T_Lot_FG['PcsPerInner_2'],
    ),array(
      "col"=>"ConvertFlag",
      "newcolval"=>$ConvertFlag,
      "oldcolval"=>$T_Lot_FG['ConvertFlag'],
    )
  ...
  if($Plant != $T_Lot_FG['PlantName']
   ...
   OR $Country != $T_Lot_FG['Country']
   OR $SOLineItemNumber != $T_Lot_FG['so_line_item']
   OR $oldBatchNumber != $T_Lot_FG['OldBatchNumber']
   OR $ctnPerPallet != $T_Lot_FG['CartonPerPallet']
   OR $ctnPerPallet2 != $T_Lot_FG['CartonPerPallet_2']
   OR $innerPerCtn1 != $T_Lot_FG['InnerPerCarton_1']
   OR $innerPerCtn2 != $T_Lot_FG['InnerPerCarton_2']
   OR $pcsPerInner1 != $T_Lot_FG['PcsPerInner_1']
   OR $pcsPerInner2 != $T_Lot_FG['PcsPerInner_2']
   OR $ConvertFlag != $T_Lot_FG['ConvertFlag']
  ){
