                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" id="inspection_stage" name="inspection_stage" required>
                      ...
                      <script>
                        $('.inspection_stage').ready(function() {
                          ...
                          if (inspection_stage == '1') {
                            $("#inspection_stage").val("1").change();
                          } else {
                            $("#inspection_stage").val("0").change();
                          }
                        })
                      </script>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="materialCode" value="<?php echo $T_Lot_FG['material_code']; ?>" id="materialCode" placeholder="Enter material code here" readonly>
                    </div>
                    <!-- /.form-group -->

                    <div class="form-group">
                      <label>Suface:</label>
                      <input type="text" class="form-control" name="SurfaceName" id="SurfaceName" value="<?php echo $T_Lot_FG['GloveSurfaceName']; ?>" readonly>
                    ...
                    <div class="form-group">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <?php $oldRef_arr = explode("-", $T_Lot_FG['OldBatchNumber']); ?>
                          <input class="form-control" name="oldSONumber" id="oldSONumber" maxlength="10" placeholder="Enter Batch Number" value="<?php echo $oldRef_arr[0]; ?>" readonly>
                          <input class="form-control" name="oldBatchID" id="oldBatchID" maxlength="10" placeholder="Enter Batch Number" value="<?php echo $oldRef_arr[1]; ?>" readonly>
                        </div>
                      </div>
                      <script>
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="form-group">
                      <label>Country:</label>
                      <input type="text" class="form-control" name="Country" id="Country" value="<?php echo $T_Lot_FG['Country']; ?>" readonly>
                    </div>
                    <!-- /.form-group -->
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" name="SOLineItemNumber" value="<?php echo $T_Lot_FG['so_line_item']; ?>" id="SOLineItemNumber" placeholder="Enter SO Line Item Number" readonly>
                    </div>
                    <!-- /.form-group -->
                  ...
                  <div class="col-lg-12">
                    ...
                    <div class="form-group col-lg-2">
                      ...
                      <input class="form-control" name="Sampling-ctn-pallet" value="<?php echo $T_Lot_FG['CartonPerPallet']; ?>">
                    </div>
                    <!-- /.form-group -->

                    <div class="form-group col-lg-2">
                      <label>1. Sampling Inner /ctn:</label>
                      <input class="form-control" name="Sampling-Inner-ctn1" value="<?php echo $T_Lot_FG['InnerPerCarton_1']; ?>">
                    </div>
                    <!-- /.form-group -->

                    <div class="form-group col-lg-2">
                      <label>1. Sampling pcs /Inner:</label>
                      <input class="form-control" name="Sampling-pcs-Inner1" value="<?php echo $T_Lot_FG['PcsPerInner_1']; ?>">
                    </div>
                    <!-- /.form-group -->

                    <div class="form-group col-lg-2">
                      <label>2. Sampling ctn /pallet:</label>
                      <input class="form-control" name="Sampling-ctn-pallet2" value="<?php echo $T_Lot_FG['CartonPerPallet_2']; ?>">
                    </div>

                    <!-- /.form-group -->
                    <div class="form-group col-lg-2">
                      <label>2. Sampling Inner /ctn:</label>
                      <input class="form-control" name="Sampling-Inner-ctn2" value="<?php echo $T_Lot_FG['InnerPerCarton_2']; ?>">
                    </div>
                    <!-- /.form-group -->

                    <div class="form-group col-lg-2">
                      <label>2. Sampling pcs /Inner:</label>
                      <input class="form-control" name="Sampling-pcs-Inner2" value="<?php echo $T_Lot_FG['PcsPerInner_2']; ?>">
                    </div>
                    <!-- /.form-group -->
                  </div>
                  <!-- /.col-lg-12 -->
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" name="InstrumentValue" id="InstrumentValue" value="<?php echo $recordInstrument_pivot['Weighing Scale ID']; ?>"><br>
                    </div>
                    <!-- /.form-group -->

                    <div class="form-group">
                      <label>RULER ID</label>
                      <input class="form-control" type="text" name="InstrumentValue2" id="InstrumentValue" value="<?php echo $recordInstrument_pivot['Ruler ID']; ?>"><br>
                    </div>
                    <!-- /.form-group -->

                    <div class="form-group">
                      <label>THICKNESS GAUGE ID</label>
                      <input class="form-control" type="text" name="InstrumentValue3" id="InstrumentValue" value="<?php echo $recordInstrument_pivot['Thickness Gauge']; ?>"><br>
                    </div>
                    <!-- /.form-group -->
              ...
              <div class="panel-body">
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    ...
                    <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
                      ...
                      <tr>
                        ...
                        <td><input type="number" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null;" class="form-control digit" name="sample_size_apt" id="sample_size_apt" value="<?php echo $recordSampleSize_pivot['SampleSizeAPT/WTTLevel1']; ?>"></td>

                        <th scope="col" class="info">SAMPLE SIZE VT:</th>
                        <td><input type="number" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null;" class="form-control digit" name="sample_size_vt" id="sample_size" value="<?php echo $recordSampleSize_pivot['SampleSizeVisual']; ?>"></td>
                      </tr>

                      <tr>
                        <th scope="col" class="info">SAMPLE SIZE APT/WTT (LEVEL 2):</th>
                        <td><input type="number" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null;" class="form-control digit" name="sample_size_apt2" id="sample_size_apt2" placeholder="0" value="<?php echo $recordSampleSize_pivot['SampleSizeAPT/WTTLevel2']; ?>"></td>

                        <th scope="col" class="info">MACHINE ID:</th>
                        <td><input class="form-control" name="machine_id" placeholder="MACHINE ID" value="<?php echo $recordInstrument_pivot['APT/WTT ID']; ?>"></td>
                      </tr>
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="form-group">
                      <label>Date:</label>
                      <input class="form-control" type="datetime-local" name="date_verify" onkeydown="return false"><br>
                    </div>
                    <!-- /.form-group -->
