        ...
        $("#totalPcsSize").keyup(function(){
          ...
          if(totalPcsSize > 0 && totalCTN > 0 && totalPcsCtn > 0 && maxCTN > 0){
            calculateProcess();
          }
        });
...
// --------------------function calculate process----------------------
        function calculateProcess(){
          var limitCTN = 0;
          totalOrder = totalPcsSize/1000;
          totalPallet = Math.ceil(totalOrder/totalCTN);
          if(totalOrder >= maxCTN ){
            limitCTN = maxCTN;
          }else{
            limitCTN = totalOrder
          }
          formulaTrigger = limitCTN;

          console.log("totalPallet: "+totalPallet);
          console.log("formulaTrigger: "+formulaTrigger);

          // ---------- lot number 1 --------------
          if(totalOrder - 1 >= limitCTN){
            _totalpallet1 = Math.floor(limitCTN/totalCTN);
            _totalCTN1 = _totalpallet1*totalCTN;
          }else{
            _totalpallet1 = Math.ceil(limitCTN/totalCTN);
            _totalCTN1 = totalOrder;
          }

          if(totalOrder >= limitCTN){
            _totalPCS1 = _totalCTN1*totalPcsCtn;
          }else{
            _totalPCS1 = totalOrder*totalPcsCtn;
          }
          ...
          if(_balanceCTN1 >= formulaTrigger){
          ...
          if(_balanceCTN1 >= _totalCTN2){
            ...
            _totalPCS2 = _balanceCTN1*totalPcsCtn;
          }
          ...
          if(_balanceCTN2 >= formulaTrigger){
          ...
          if(_balanceCTN2 >= _totalCTN3){
            ...
            _totalPCS3 = _balanceCTN2*totalPcsCtn;
          }
          ...
          if(_balanceCTN3 >= formulaTrigger){
          ...
          if(_balanceCTN3 >= _totalCTN4){
            ...
            _totalPCS4 = _balanceCTN3*totalPcsCtn;
          }
          ...
          if(_balanceCTN4 >= formulaTrigger){
          ...
          if(_balanceCTN4 >= _totalCTN5){
            ...
            _totalPCS5 = _balanceCTN4*totalPcsCtn;
          }
          ...
          if(_balanceCTN5 >= formulaTrigger){
