                ...
                <table class="table table-bordered" id="tableID" width="30%" cellspacing="0">
                  ...
                  <?php
                    if(isset($_POST['search'])){
                                  ...
                                  foreach ($distinct_Insp as $groupInsp) {
                                    ...
                                    if(isset($tablebyLot[$groupsize][$grouplotcount][$groupcondition][$groupInsp])){
                                      ...
                                      foreach ($tablebyLot[$groupsize][$grouplotcount][$groupcondition][$groupInsp] as $tablebyLotRow) {
                                        // code...
                                          // echo $groupsize."| ".$grouplotcount."| ".$groupcondition."| ".$groupInsp."| ";
                                          ...
                                          //----------LotNumber---------------------------
                                          $summary_Table_byLot['LotNumber'][$tab_i] = '';
                                          //----------LotCount---------------------------
                                      ...
                                      if (array_key_last($tablebyLotRow)){
                                        // echo "here <br />";
                                        $tab_i++;
                                      }
                                    }
                      ...
                      // echo "
                      //   <script>
                      //     var sumtable = JSON.parse('".json_encode($summary_Table_byLot)."');
                      ...
                      for ($row_i = 0; $row_i < count($summary_Table_byLot['SONumber']); $row_i++) {
                        // echo "<br />";
                        // echo "<br />".$row_i;
